...
export default function Contact() {
  return (
    ...
    >
      ...
      {/* Intro Text */}
      <p className="w-auto mx-auto text-muted-foreground text-base sm:text-lg mb-10 leading-relaxed">
        Let’s connect! I welcome discussions about projects, collaborations and
        career opportunities. You can reach me directly via email, phone, or
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-12">
        ...
        >
          <img
            src={emailIcon}
            alt="Email"
            className="w-5 sm:w-6 opacity-80 hover:opacity-100"
          />
